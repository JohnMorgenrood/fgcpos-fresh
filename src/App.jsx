        ...
        <div className="relative z-10 text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">Order delicious food for delivery</p>
            </div>
            
            <div className="space-y-4">
              <button 
                onClick={() => setUserRole('customer')}
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-5 px-6 rounded-2xl hover:from-orange-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105 shadow-xl text-lg"
              >
                <div className="flex items-center justify-center space-x-3">
                  <span className="text-2xl">📱</span>
                  <span>Order Food</span>
                </div>
                <div className="text-sm opacity-90 mt-1">Browse menu & place order</div>
              </button>
              
              <button 
                onClick={() => setUserRole('admin')}
                className="w-full bg-gradient-to-r from-gray-700 to-gray-800 text-white font-bold py-5 px-6 rounded-2xl hover:from-gray-800 hover:to-gray-900 transition-all duration-300 transform hover:scale-105 shadow-xl text-lg"
              >
                <div className="flex items-center justify-center space-x-3">
                  <span className="text-2xl">👨‍💼</span>
                  <span>Staff Login</span>
                </div>
                <div className="text-sm opacity-90 mt-1">Manage orders & menu</div>
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">🔥 Flame Grilled</h1>
              ...
              <button 
                ...
                className="relative p-3 bg-orange-500 text-white rounded-full shadow-lg hover:bg-orange-600 transition-colors"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="p-4 bg-white border-b border-gray-200">
          <div className="relative">
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:border-transparent text-lg"
            />
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button 
                        ...
                        className="bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-600 transition-all duration-200 transform hover:scale-105 shadow-lg"
                      >
                        Add to Cart
                      </button>
                    </div>
